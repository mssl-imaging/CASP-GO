...
CBatchProc::CBatchProc(string strMetaFile, string strLeftImagePath, string strRightImagePath, string strDisparityX, string strDisparityY, string strOutputPrefix)
{
    // initialise
